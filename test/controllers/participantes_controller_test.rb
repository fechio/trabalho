...
class ParticipantesControllerTest < ActionController::TestCase
  ...
  test "should create participante" do
    assert_difference('Participante.count') do
      post :create, participante: { cidade: @participante.cidade, descricao: @participante.descricao, email: @participante.email, estado: @participante.estado, foto: @participante.foto, login: @participante.login, nome: @participante.nome, senha: @participante.senha }
    end
  ...
  test "should update participante" do
    patch :update, id: @participante, participante: { cidade: @participante.cidade, descricao: @participante.descricao, email: @participante.email, estado: @participante.estado, foto: @participante.foto, login: @participante.login, nome: @participante.nome, senha: @participante.senha }
    assert_redirected_to participante_path(assigns(:participante))
  end
